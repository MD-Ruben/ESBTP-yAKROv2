...
//                 // Ignorer les séances de pause ou déjeuner
//                 if (in_array($seance->type_seance, ['pause', 'dejeuner']) || in_array($autreSeance->type_seance, ['pause', 'dejeuner'])) {
//                     continue;
//                 }
...
//                 'emploi_temps_id' => 'required|exists:esbtp_emploi_temps,id',
//                 'details' => 'nullable|string',
//                 'salle' => $isBreak ? 'nullable|string' : 'required|string',
//                 'matiere_id' => $isBreak ? 'nullable|exists:esbtp_matieres,id' : 'required|exists:esbtp_matieres,id',
