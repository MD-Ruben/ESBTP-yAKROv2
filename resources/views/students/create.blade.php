        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-esbtp-green text-white">
                    <h5 class="card-title mb-0">Ajouter un Nouvel Étudiant</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="tab-pane fade" id="parent" role="tabpanel" aria-labelledby="parent-tab">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="parent_option" id="existing_parent" value="existing" checked>
                                        <label class="form-check-label" for="existing_parent">Parent existant</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="parent_option" id="new_parent" value="new">
