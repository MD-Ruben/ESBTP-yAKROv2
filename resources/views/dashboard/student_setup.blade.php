                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        <div class="col-md-7 p-5">
                            ...
                            <p class="lead mb-4 animate__animated animate__fadeInUp animate__delay-1s">Votre compte étudiant a été créé avec succès. Quelques étapes supplémentaires sont nécessaires pour finaliser votre profil académique.</p>
                            <div class="d-flex gap-3 animate__animated animate__fadeInUp animate__delay-2s">
                                <a href="{{ route('student.profile') }}" class="btn btn-primary px-4 py-2">
                        ...
                        <div class="col-md-5 d-none d-md-block" style="background: linear-gradient(135deg, var(--esbtp-green-light), var(--esbtp-green));">
                            <div class="h-100 d-flex align-items-center justify-content-center p-4">
                                <img src="https://img.freepik.com/free-vector/college-university-students-group-young-happy-people-standing-isolated-white-background_575670-66.jpg" alt="Student Setup" class="img-fluid animate__animated animate__fadeInRight" style="max-height: 250px;">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="setup-step pending">
                                            ...
                                            <h6 class="mt-3 mb-1">Classe assignée</h6>
                                ...
                                <div class="accordion-item border-0 mb-3 shadow-sm rounded">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button collapsed rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                            Quand pourrai-je accéder à mon emploi du temps ?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            Vous aurez accès à votre emploi du temps une fois que l'administrateur aura validé votre profil et vous aura assigné à une classe.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item border-0 mb-3 shadow-sm rounded">
                                ...
                                <div class="accordion-item border-0 shadow-sm rounded">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Comment accéder à mes notes et résultats ?
                                        </button>
                                    </h2>
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            Vos notes et résultats seront accessibles dans la section "Notes" une fois que votre profil sera complètement configuré et que vous serez assigné à une classe.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-body p-4">
                <form action="{{ route('messages.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="subject" name="subject" value="Configuration du profil étudiant" required>
                    </div>
                    <div class="mb-3">
