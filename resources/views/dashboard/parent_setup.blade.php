...
@section('title', 'Configuration du profil parent')
                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        <div class="col-md-7 p-5">
                            ...
                            <p class="lead mb-4 animate__animated animate__fadeInUp animate__delay-1s">Votre compte parent a été créé avec succès. Quelques étapes supplémentaires sont nécessaires pour finaliser votre profil et associer vos enfants.</p>
                            <div class="d-flex gap-3 animate__animated animate__fadeInUp animate__delay-2s">
                                <a href="{{ route('parent.dashboard') }}" class="btn btn-primary px-4 py-2">
                        ...
                        <div class="col-md-5 d-none d-md-block" style="background: linear-gradient(135deg, var(--esbtp-green-light), var(--esbtp-green));">
                            <div class="h-100 d-flex align-items-center justify-content-center p-4">
                                <img src="https://img.freepik.com/free-vector/happy-family-with-children-concept-illustration_114360-2947.jpg" alt="Parent Setup" class="img-fluid animate__animated animate__fadeInRight" style="max-height: 250px;">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="setup-step pending">
                                            ...
                                            <h6 class="mt-3 mb-1">Enfants associés</h6>
                                            <p class="text-muted small mb-0">En attente d'association par l'admin</p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="setup-step pending">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0 py-3 d-flex align-items-center border-0 border-bottom">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0 small">Ajoutez vos informations personnelles et coordonnées</p>
                                    </div>
                                </li>
                                <li class="list-group-item px-0 py-3 d-flex align-items-center border-0 border-bottom">
                                ...
                                <div class="accordion-item border-0 mb-3 shadow-sm rounded">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button collapsed rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                            Comment puis-je voir les informations de mes enfants ?
                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            Vous pourrez accéder aux informations de vos enfants une fois que l'administrateur aura associé leurs comptes au vôtre. Vous recevrez une notification lorsque cette étape sera terminée.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item border-0 mb-3 shadow-sm rounded">
                                ...
                                <div class="accordion-item border-0 shadow-sm rounded">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            Comment suivre les résultats scolaires de mes enfants ?
                                        </button>
                                    </h2>
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            Une fois votre profil complètement configuré et vos enfants associés, vous pourrez accéder à leurs résultats scolaires, emplois du temps et autres informations académiques depuis votre tableau de bord.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-body p-4">
                <form action="{{ route('messages.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="subject" name="subject" value="Configuration du profil parent" required>
                    </div>
                    <div class="mb-3">
