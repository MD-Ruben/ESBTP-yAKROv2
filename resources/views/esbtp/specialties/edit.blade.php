        ...
        <div class="col-md-12">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Modifier la Spécialité: {{ $specialty->name }}</h3>
                </div>
                <!-- /.card-header -->
                
                <!-- form start -->
                <form method="POST" action="{{ route('esbtp.specialties.update', $specialty->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $specialty->name) }}" required placeholder="Entrez le nom de la spécialité (ex: Génie Civil)">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', $specialty->code) }}" required placeholder="Entrez le code de la spécialité (ex: GC)">
                                    @error('code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('cycle_id') is-invalid @enderror" id="cycle_id" name="cycle_id" required>
                                        ...
                                        @foreach($cycles as $cycle)
                                            <option value="{{ $cycle->id }}" {{ old('cycle_id', $specialty->cycle_id) == $cycle->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('coordinator_name') is-invalid @enderror" id="coordinator_name" name="coordinator_name" value="{{ old('coordinator_name', $specialty->coordinator_name) }}" placeholder="Nom du responsable de la spécialité">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $specialty->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('esbtp.specialties.show', $specialty->id) }}" class="btn btn-default">Annuler</a>
                    </div>
                </form>
            </div>
            <!-- /.card -->
