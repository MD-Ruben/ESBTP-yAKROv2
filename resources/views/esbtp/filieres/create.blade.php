...
@section('title', 'Créer une nouvelle filière ESBTP')
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Créer une nouvelle filière</h3>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id">
                                ...
                                @foreach($parentFilieres as $parentFiliere)
                                    <option value="{{ $parentFiliere->id }}" {{ old('parent_id') == $parentFiliere->id ? 'selected' : '' }}>
