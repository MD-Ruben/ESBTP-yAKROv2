...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Modifier la dépense: {{ $depense->reference ?? 'N°'.$depense->id }}</h5>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('esbtp.comptabilite.depenses.update', $depense->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('libelle') is-invalid @enderror" id="libelle" name="libelle" value="{{ old('libelle', $depense->libelle) }}" required>
                        @error('libelle')
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('categorie_id') is-invalid @enderror" id="categorie_id" name="categorie_id" required>
                            ...
                            <option value="{{ $categorie->id }}" {{ old('categorie_id', $depense->categorie_id) == $categorie->id ? 'selected' : '' }}>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('montant') is-invalid @enderror" id="montant" name="montant" value="{{ old('montant', $depense->montant) }}" min="0" step="0.01" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('date_depense') is-invalid @enderror" id="date_depense" name="date_depense" value="{{ old('date_depense', $depense->date_depense ? $depense->date_depense->format('Y-m-d') : '') }}" required>
                        @error('date_depense')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('mode_paiement') is-invalid @enderror" id="mode_paiement" name="mode_paiement" required>
                            ...
                            <option value="espèces" {{ old('mode_paiement', $depense->mode_paiement) == 'espèces' ? 'selected' : '' }}>Espèces</option>
                            <option value="chèque" {{ old('mode_paiement', $depense->mode_paiement) == 'chèque' ? 'selected' : '' }}>Chèque</option>
                            <option value="virement" {{ old('mode_paiement', $depense->mode_paiement) == 'virement' ? 'selected' : '' }}>Virement</option>
                            <option value="carte bancaire" {{ old('mode_paiement', $depense->mode_paiement) == 'carte bancaire' ? 'selected' : '' }}>Carte bancaire</option>
                            <option value="mobile money" {{ old('mode_paiement', $depense->mode_paiement) == 'mobile money' ? 'selected' : '' }}>Mobile Money</option>
                        </select>
                        @error('mode_paiement')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('reference') is-invalid @enderror" id="reference" name="reference" value="{{ old('reference', $depense->reference) }}">
                        @error('reference')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('numero_transaction') is-invalid @enderror" id="numero_transaction" name="numero_transaction" value="{{ old('numero_transaction', $depense->numero_transaction) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2 @error('fournisseur_id') is-invalid @enderror" id="fournisseur_id" name="fournisseur_id">
                            ...
                            <option value="{{ $fournisseur->id }}" {{ old('fournisseur_id', $depense->fournisseur_id) == $fournisseur->id ? 'selected' : '' }}>
                                {{ $fournisseur->nom }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <div class="mb-2">
                            <span class="text-success"><i class="fas fa-check-circle me-1"></i> Un justificatif existe déjà</span>
                            <a href="{{ asset('storage/' . $depense->path_justificatif) }}" target="_blank" class="btn btn-sm btn-outline-info ms-2">
                                <i class="fas fa-eye me-1"></i> Voir
                            </a>
                            <small class="text-muted ms-2">Téléverser un nouveau fichier pour remplacer l'existant</small>
                        </div>
                        @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('notes_internes') is-invalid @enderror" id="notes_internes" name="notes_internes" rows="2">{{ old('notes_internes', $depense->notes_internes) }}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('statut') is-invalid @enderror" id="statut" name="statut">
                            <option value="validée" {{ old('statut', $depense->statut) == 'validée' ? 'selected' : '' }}>Validée</option>
                            <option value="en attente" {{ old('statut', $depense->statut) == 'en attente' ? 'selected' : '' }}>En attente</option>
                            <option value="annulée" {{ old('statut', $depense->statut) == 'annulée' ? 'selected' : '' }}>Annulée</option>
                        </select>
                        @error('statut')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
