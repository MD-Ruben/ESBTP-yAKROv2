...
@section('title', 'Nouvelle bourse')

@section('content')
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Créer une nouvelle bourse</h5>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('esbtp.comptabilite.bourses.store') }}" method="POST">
                @csrf
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('type_bourse') is-invalid @enderror" id="type_bourse" name="type_bourse" required>
                            ...
                            <option value="mérite" {{ old('type_bourse') == 'mérite' ? 'selected' : '' }}>Bourse au mérite</option>
                            <option value="sociale" {{ old('type_bourse') == 'sociale' ? 'selected' : '' }}>Bourse sociale</option>
                            <option value="excellence" {{ old('type_bourse') == 'excellence' ? 'selected' : '' }}>Bourse d'excellence</option>
                            <option value="partielle" {{ old('type_bourse') == 'partielle' ? 'selected' : '' }}>Bourse partielle</option>
                            <option value="complète" {{ old('type_bourse') == 'complète' ? 'selected' : '' }}>Bourse complète</option>
                            <option value="autre" {{ old('type_bourse') == 'autre' ? 'selected' : '' }}>Autre</option>
                        </select>
                        @error('type_bourse')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('organisme_financeur') is-invalid @enderror" id="organisme_financeur" name="organisme_financeur" value="{{ old('organisme_financeur') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div id="montant_group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('montant') is-invalid @enderror" id="montant" name="montant" value="{{ old('montant') }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div id="pourcentage_group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('pourcentage') is-invalid @enderror" id="pourcentage" name="pourcentage" value="{{ old('pourcentage') }}" min="0" max="100">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('conditions') is-invalid @enderror" id="conditions" name="conditions" rows="3">{{ old('conditions') }}</textarea>
                        @error('conditions')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
