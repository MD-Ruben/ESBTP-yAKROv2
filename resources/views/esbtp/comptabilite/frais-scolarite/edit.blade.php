...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Modifier la configuration des frais de scolarité</h5>
            <div>
                <a href="{{ route('esbtp.comptabilite.frais-scolarite.show', $fraisScolarite->id) }}" class="btn btn-info btn-sm">
            ...
            <form action="{{ route('esbtp.comptabilite.frais-scolarite.update', $fraisScolarite->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('filiere_id') is-invalid @enderror" id="filiere_id" name="filiere_id" required>
                            ...
                            <option value="{{ $filiere->id }}" {{ (old('filiere_id', $fraisScolarite->filiere_id) == $filiere->id) ? 'selected' : '' }}>
                                {{ $filiere->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('niveau_id') is-invalid @enderror" id="niveau_id" name="niveau_id" required>
                            ...
                            <option value="{{ $niveau->id }}" {{ (old('niveau_id', $fraisScolarite->niveau_id) == $niveau->id) ? 'selected' : '' }}>
                                {{ $niveau->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('annee_universitaire_id') is-invalid @enderror" id="annee_universitaire_id" name="annee_universitaire_id" required>
                            ...
                            <option value="{{ $annee->id }}" {{ (old('annee_universitaire_id', $fraisScolarite->annee_universitaire_id) == $annee->id) ? 'selected' : '' }}>
                                {{ $annee->name }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('montant_total') is-invalid @enderror" id="montant_total" name="montant_total" value="{{ old('montant_total', $fraisScolarite->montant_total) }}" required min="0">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('frais_inscription') is-invalid @enderror" id="frais_inscription" name="frais_inscription" value="{{ old('frais_inscription', $fraisScolarite->frais_inscription) }}" required min="0">
                            <span class="input-group-text">FCFA</span>
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('frais_mensuel') is-invalid @enderror" id="frais_mensuel" name="frais_mensuel" value="{{ old('frais_mensuel', $fraisScolarite->frais_mensuel) }}" min="0">
                            <span class="input-group-text">FCFA</span>
                        </div>
                        @error('frais_mensuel')
                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('frais_trimestriel') is-invalid @enderror" id="frais_trimestriel" name="frais_trimestriel" value="{{ old('frais_trimestriel', $fraisScolarite->frais_trimestriel) }}" min="0">
                            <span class="input-group-text">FCFA</span>
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('frais_semestriel') is-invalid @enderror" id="frais_semestriel" name="frais_semestriel" value="{{ old('frais_semestriel', $fraisScolarite->frais_semestriel) }}" min="0">
                            <span class="input-group-text">FCFA</span>
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('frais_annuel') is-invalid @enderror" id="frais_annuel" name="frais_annuel" value="{{ old('frais_annuel', $fraisScolarite->frais_annuel) }}" min="0">
                            <span class="input-group-text">FCFA</span>
                        </div>
                        @error('frais_annuel')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('nombre_echeances') is-invalid @enderror" id="nombre_echeances" name="nombre_echeances" value="{{ old('nombre_echeances', $fraisScolarite->nombre_echeances) }}" required min="1" max="12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" id="est_actif" name="est_actif" value="1" {{ old('est_actif', $fraisScolarite->est_actif) ? 'checked' : '' }}>
                            <label class="form-check-label" for="est_actif">Configuration active</label>
                        </div>
                        <small class="form-text text-muted">Une configuration inactive n'est pas utilisée pour les nouveaux étudiants</small>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('details') is-invalid @enderror" id="details" name="details" rows="3">{{ old('details', $fraisScolarite->details) }}</textarea>
                        @error('details')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
