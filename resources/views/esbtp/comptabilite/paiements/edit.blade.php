...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('esbtp.comptabilite.paiements.show', $paiement->id) }}" class="btn btn-secondary">
            ...
            <form action="{{ route('esbtp.comptabilite.paiements.update', $paiement->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3">{{ old('description', $paiement->description) }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
