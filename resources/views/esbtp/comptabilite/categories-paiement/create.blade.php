...
@section('title', 'Créer une nouvelle catégorie de paiement')
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Créer une nouvelle catégorie de paiement</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('esbtp.comptabilite.categories-paiement.store') }}" method="POST" id="categoryForm">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('ordre') is-invalid @enderror" id="ordre" name="ordre" value="{{ old('ordre', 1) }}" min="1">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i id="selectedIconPreview" class="fas fa-money-bill"></i></span>
                                    <input type="text" class="form-control @error('icone') is-invalid @enderror" id="icone" name="icone" value="{{ old('icone', 'fas fa-money-bill') }}">
                                ...
                                <div class="icon-picker-container mt-2 d-none" id="iconPicker">
                                    <div class="icon-option selected" data-icon="fas fa-money-bill"><i class="fas fa-money-bill"></i></div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="color" class="form-control form-control-color" id="couleurPicker" value="{{ old('couleur', '#3498db') }}">
                                    <input type="text" class="form-control @error('couleur') is-invalid @enderror" id="couleur" name="couleur" value="{{ old('couleur', '#3498db') }}">
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="est_obligatoire" name="est_obligatoire" value="1" {{ old('est_obligatoire') ? 'checked' : '' }}>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <button type="button" class="btn btn-secondary me-md-2" onclick="window.history.back();">Annuler</button>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-preview">
                        <div class="preview-header" id="previewHeader" style="background-color: #3498db;">
                            <i id="previewIcon" class="fas fa-money-bill preview-icon"></i>
                            <h5 id="previewTitle" class="mb-0">Nom de la catégorie</h5>
                        </div>
                        <div class="mt-3">
                            <p><strong>Code:</strong> <span id="previewCode">CODE</span></p>
                            <p><strong>Description:</strong> <span id="previewDescription">Description de la catégorie...</span></p>
                            <p>
                                <span id="previewObligatoire" class="badge bg-danger">Obligatoire</span>
                                <span id="previewActif" class="badge bg-success">Actif</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info mt-4">
                        ...
                        <ul class="mb-0">
                            ...
                            <li>Choisissez des codes courts mais explicites</li>
                            <li>Les catégories peuvent être organisées hiérarchiquement</li>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize preview
        previewObligatoire.style.display = obligatoireInput.checked ? 'inline-block' : 'none';
