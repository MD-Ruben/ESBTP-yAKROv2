                ...
                <div class="card-body">
                    @if($inscriptionActive)
                        <div class="alert alert-success">
                            ...
                            <p>Vous êtes actuellement inscrit(e) pour l'année universitaire {{ $inscriptionActive->anneeUniversitaire->libelle ?? 'Non spécifiée' }}.</p>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">{{ $inscriptionActive->filiere->nom ?? 'Non spécifiée' }}</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">{{ $inscriptionActive->niveau->nom ?? 'Non spécifié' }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">{{ $inscriptionActive->classe->name ?? 'Non spécifiée' }}</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">{{ \Carbon\Carbon::parse($inscriptionActive->date_inscription)->format('d/m/Y') }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ number_format($inscriptionActive->frais_inscription, 0, ',', ' ') }} FCFA</td>
                                        <td>{{ number_format($inscriptionActive->montant_scolarite, 0, ',', ' ') }} FCFA</td>
                                        <td>{{ number_format($inscriptionActive->paiements->sum('montant'), 0, ',', ' ') }} FCFA</td>
                                        <td>{{ number_format($inscriptionActive->montant_scolarite - $inscriptionActive->paiements->sum('montant'), 0, ',', ' ') }} FCFA</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $inscription->anneeUniversitaire->libelle ?? 'Non spécifiée' }}</td>
                                        <td>{{ $inscription->filiere->nom ?? 'Non spécifiée' }}</td>
                                        <td>{{ $inscription->niveau->nom ?? 'Non spécifié' }}</td>
